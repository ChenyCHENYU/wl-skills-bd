...
const commonStubs = {
  ...
  "javax/validation/constraints/Digits.java": `package javax.validation.constraints; public @interface Digits { int integer(); int fraction(); String message() default ""; }`,
  "javax/validation/constraints/DecimalMin.java": `package javax.validation.constraints; public @interface DecimalMin { String value(); boolean inclusive() default true; String message() default ""; }`,
  "javax/validation/constraints/DecimalMax.java": `package javax.validation.constraints; public @interface DecimalMax { String value(); boolean inclusive() default true; String message() default ""; }`,
  "javax/validation/constraints/Pattern.java": `package javax.validation.constraints; public @interface Pattern { String regexp(); String message() default ""; }`,
...
const modelStubs = {
  "com/jhict/mdm/api/entity/feature/MdmFeatureCategory.java": `package com.jhict.mdm.api.entity.feature; import com.jhict.common.core.entity.CoreEntity; public class MdmFeatureCategory extends CoreEntity { private Integer deleteFlag; private Integer revision; public Integer getRevision(){return revision;} public void setRevision(Integer value){revision=value;} public Integer getDeleteFlag(){return deleteFlag;} public void setDeleteFlag(Integer value){deleteFlag=value;} }`,
...
const extensionModelStubs = {
  "com/jhict/sale/api/entity/order/SaleOrderMaster.java": `package com.jhict.sale.api.entity.order; import com.jhict.common.core.entity.CoreEntity; public class SaleOrderMaster extends CoreEntity { private Integer deleteFlag; private Integer revision; private String status; private String approvalOpinion; public Integer getRevision(){return revision;} public void setRevision(Integer value){revision=value;} public Integer getDeleteFlag(){return deleteFlag;} public void setDeleteFlag(Integer value){deleteFlag=value;} public String getStatus(){return status;} public void setStatus(String value){status=value;} public String getApprovalOpinion(){return approvalOpinion;} public void setApprovalOpinion(String value){approvalOpinion=value;} }`,
