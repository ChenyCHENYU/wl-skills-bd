...
const commonStubs = {
  ...
  "org/junit/jupiter/api/Assertions.java": `package org.junit.jupiter.api; public final class Assertions { public static void assertEquals(Object expected,Object actual){} }`,
  ...
  "org/mockito/Mockito.java": `package org.mockito; import org.mockito.stubbing.OngoingStubbing; public final class Mockito { public static <T> OngoingStubbing<T> when(T value){return null;} }`,
  "org/mockito/ArgumentMatchers.java": `package org.mockito; public final class ArgumentMatchers { public static <T> T any(Class<T> type){return null;} }`,
