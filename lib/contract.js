...
function validateContract(raw, options = {}) {
  ...
  const topKeys = [
    ...
    "indexes", "customOperations", "relations", "validationRules", "alter", "assurance", "errors",
  ];
  const topRequired = topKeys.filter((key) => !["output", "externalId", "environment", "dbCluster", "databaseTarget", "indexes", "customOperations", "relations", "validationRules", "alter", "assurance", "errors"].includes(key));
