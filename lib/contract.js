...
const { physicalIdentifier, resolveGovernance, softDeleteComment, validateGovernance } = require("./governance");
...
function validateIndexes(errors, rawIndexes, location, database, allowedColumns) {
  ...
  return rawIndexes.map((entry, index) => {
    ...
    if (entry.unique === true && entry.columns.includes(physicalIdentifier(database, "IS_DELETE"))) {
