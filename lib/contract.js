...
function resolveProfile(profileId, projectRoot) {
  ...
  if (!sharedResponse || sharedResponse.successCode !== profile.response.successCode
    ...
    || sharedPagination.requestCurrent !== "current"
    || sharedPagination.requestSize !== "size"
    || sharedPagination.defaultCurrent !== 1
    || sharedPagination.defaultSize !== 10
    || sharedPagination.maxSize !== 200
