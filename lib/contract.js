...
function validateContract(raw, options = {}) {
  ...
  const topKeys = [
    ...
    "environment", "dbCluster", "databaseTarget",
    "entity", "api", "database", "migration", "output", "fields",
    "indexes", "customOperations", "relations", "validationRules", "alter", "assurance", "errors", "logicalIds", "integrations",
  ];
  const topRequired = topKeys.filter((key) => !["contractKind", "output", "externalId", "environment", "dbCluster", "databaseTarget", "indexes", "customOperations", "relations", "validationRules", "alter", "assurance", "errors", "logicalIds", "integrations"].includes(key));
