...
const { resolveGovernance, softDeleteComment } = require("./governance");
const { hashBuffer, hashFile, normalizeRel, resolveWithin, writeJsonAtomic, writeTextAtomic: writeManagedTextAtomic } = require("./manifest");
...
function writeTextAtomic(file, content) {
  writeManagedTextAtomic(file, content);
}
