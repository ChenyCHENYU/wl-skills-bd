...
- v0.17.10：28 条 standards、12 个 Skill、16 个模板/17+N 个生成产物、7 个配置模板、B1~B28、J1~J8、16 个 MCP 工具；补字段边界、分页、OpenAPI 握手、父 BOM 依赖漂移、框架扩展点 Bean 唯一性与真实运行验证闭环，全部由契约/Profile/兼容矩阵驱动，不绑定具体业务模块。
