...
| 生成 Service / 全套 CRUD / 实现业务方法                | [`core/service-codegen`](core/service-codegen/SKILL.md)                  | ④   | ✅ 落地  | —          |
...
| 后端环境标准化 / 切华新 / 本地启动配不起来 / K8s 部署清单对齐 | [`ops/standard-env-config-be`](ops/standard-env-config-be/SKILL.md) | ops  | ✅ 落地  | —          |

**落地度**：10 个 Skill 中 **6 已落地**（③④⑤⑧⑨ + env-config）/ **4 骨架**（② api-design / ②预 business-doc / ⑥ db-migration / ⑦ unit-test）。
